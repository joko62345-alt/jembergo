...
class PerubahanPemesanan extends Model
{
    ...
    protected $fillable = ['id_pemesanan', 'order_id', 'transaction_id', 'anggota_baru', 'nominal', 'gross_amount', 'status', 'transaction_status', 'payment_type', 'metode_pembayaran', 'referensi_gateway', 'qris_url', 'qris_expires_at', 'waktu_pembayaran', 'paid_at'];
