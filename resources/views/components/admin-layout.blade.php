    ...
    <div class="superadmin-app">
        ...
        <div class="superadmin-main">
            <header class="superadmin-topbar">
                ...
                <div class="user-chip"><span class="user-avatar" aria-hidden="true">{{ strtoupper(substr(session('jg_user_name', 'AP'), 0, 1)) }}</span><span class="d-none d-sm-block text-start"><strong>{{ session('jg_user_name', 'Admin Pariwisata') }}</strong><small>Admin Pariwisata</small></span></div>
            </header>
