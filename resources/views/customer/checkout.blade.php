...
<main class="container checkout-page">
    ...
    <div class="checkout-heading"><div><span class="checkout-eyebrow"></span><h1>Konfirmasi dan pembayaran</h1><p>Periksa kembali pesananmu sebelum memilih metode pembayaran.</p></div><span class="checkout-code"><i class="bi bi-receipt"></i> {{ $booking->kode_booking }}</span></div>
...
<style>
    ...
    .checkout-heading h1 { margin: .45rem 0 .35rem; font-size: clamp(1.25rem, 1.8vw, 1.55rem) !important; line-height: 1.2; font-weight: 650; }
    ...
    .checkout-section-title { font-size: 1rem !important; font-weight: 650; color: #173b60; }
    .checkout-summary { display: flex; justify-content: space-between; gap: 1rem; padding: 1rem; margin: 1.25rem 0; border-radius: 1rem; background: #f5f9fb; }.checkout-date small:last-child { color: #567087; font-size: .75rem; }
    ...
    .qris-only-note { display:flex; align-items:center; gap:.75rem; padding:1rem; margin-bottom:1.25rem; border:1px solid #dbe6ee; border-radius:.85rem; background:#fff; }.qris-only-note > i { color:#315d78; font-size:1.3rem; }.qris-only-note strong,.qris-only-note small { display:block; }.qris-only-note strong { color:#173b60; font-size:.92rem; }.qris-only-note small { margin-top:.15rem; color:#7890a1; font-size:.78rem; }
    .checkout-submit { position: relative; display: flex; align-items: center; justify-content: center; width: 100%; padding: .9rem 1.1rem; border: 0; border-radius: .85rem; background: var(--jg-orange); color: #fff; font-weight: 600; box-shadow: 0 8px 18px rgba(245, 139, 5, .2); }.checkout-submit i { position: absolute; right: 1.1rem; }.checkout-submit:hover { background: #df7900; }
    .checkout-side { position: sticky; top: 6.5rem; padding: 1.5rem; border: 1px solid #dbe6ee; border-radius: 1rem; background: linear-gradient(145deg, #f7fbfc, #edf7fa); }.checkout-side h2 { margin: 1rem 0 .4rem; font-size: 1.05rem !important; font-weight: 600; }.checkout-side p { font-size: .88rem; }.checkout-side-line { display: flex; gap: .6rem; align-items: flex-start; padding-top: .8rem; margin-top: .8rem; border-top: 1px solid rgba(127, 187, 221, .3); color: #567087; font-size: .8rem; }.checkout-side-line i { color: var(--jg-orange); }
