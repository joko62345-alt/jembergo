...
<main class="container checkout-page">
    ...
    <div class="row g-4 align-items-start"><div class="col-lg-7"><div class="customer-card checkout-card"><div class="card-body p-4 p-lg-5">
        ...
        <div class="alert alert-warning"><i class="bi bi-qr-code-scan me-1"></i><strong>Pembayaran QRIS:</strong> Selesaikan pembayaran melalui QRIS. E-ticket diterbitkan setelah pembayaran berhasil dikonfirmasi.</div>
        ...
        <form method="POST" action="{{ route('customer.payment', $booking->id_pemesanan) }}">@csrf<label class="checkout-section-title d-block mb-3" for="qris-payment">Metode pembayaran</label><div class="payment-options"><label class="payment-option is-selected"><input id="qris-payment" type="radio" name="metode_pembayaran" value="QRIS" checked><span class="payment-option-icon"><i class="bi bi-qr-code-scan"></i></span><span><strong>QRIS</strong><small>Bayar dengan QRIS melalui kanal pembayaran yang tersedia.</small></span><i class="bi bi-check-circle-fill payment-check"></i></label></div><button class="checkout-submit" type="submit"><span>Lanjutkan pembayaran QRIS</span><i class="bi bi-arrow-right"></i></button></form>
