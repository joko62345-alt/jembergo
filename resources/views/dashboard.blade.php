    ...
    <aside class="app-sidebar flex-shrink-0 p-3">
        ...
        <nav class="nav flex-column gap-2 mt-2">
            ...
            @elseif($role === 'ADMIN_PARIWISATA')
                ...
                <a href="{{ route('admin.bookings') }}" class="nav-link"><i class="bi bi-calendar-check me-2"></i><span class="nav-label">Pemesanan destinasi</span></a>
