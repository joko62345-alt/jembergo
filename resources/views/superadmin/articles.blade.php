...
<body class="bg-light">
    <main class="container py-5">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            <div><a href="{{ route('dashboard') }}" class="text-dark text-decoration-none">Dashboard</a><h1 class="h2 fw-bold mt-2 mb-1">Artikel Publik</h1><p class="text-secondary mb-0">Kelola artikel Published dan Draft.</p></div>
