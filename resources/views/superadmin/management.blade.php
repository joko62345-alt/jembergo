...
@section('content')
    <div class="page-heading"><span class="page-kicker">Administrasi sistem</span><h1>Manajemen JemberGo</h1><p>Kelola akun dan data utama aplikasi pariwisata.</p></div>
